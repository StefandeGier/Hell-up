            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="cohort" class="col-md-4 col-form-label text-md-right">{{ __('Cohort') }}</label>

                            <div class="col-md-6">
                                <input id="cohort" type="number" class="form-control{{ $errors->has('cohort') ? ' is-invalid' : '' }}" name="cohort" value="{{ old('cohort') }}" required autofocus>

                                @if ($errors->has('cohort'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('cohort') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
